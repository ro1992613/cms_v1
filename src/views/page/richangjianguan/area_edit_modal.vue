...
export default {
  ...
  mounted: function() {
    let data = JSON.parse(JSON.stringify(this.$props.prop_value.rows));
    let areaList = JSON.parse(JSON.stringify(this.$props.prop_value.areaList));
    if (data.tags) {
